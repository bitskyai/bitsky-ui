 ...
 */
export default {
  'app.containers.HeadlessAgent.subTitle': 'Launch a Chromium instance and execute your Intelligences',
  'app.containers.HeadlessAgent.description': 'Headless agent is based on <a href="https://pptr.dev/">Puppeteer</a>, and it is good for crawl data from Single Page Application.',
  ...
  'app.containers.HeadlessAgent.screenshots': 'Catch Screenshots',
  ...
  'app.containers.HeadlessAgent.customFunctionTimeoutInvalid': 'Please enter a valid custom function timeout value',
