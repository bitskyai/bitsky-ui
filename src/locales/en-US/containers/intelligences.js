...
export default {
  'app.containers.Intelligences.header': 'Intelligences',
  'app.containers.Intelligences.intelligences': 'Intelligences',
  'app.containers.Intelligences.emptyIntelligences':
    'You don\'t have any <a href="https://docs.munew.io/overview#intelligence" target="_blank">Intelligences</a>',
  ...
  'app.containers.Intelligences.deleteAllSuccessful': 'Successfully delete intelligences',
};
