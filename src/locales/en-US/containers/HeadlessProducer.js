...
export default {
  ...
  'app.containers.HeadlessProducer.userDataDirDescription': `<p class="bitsky-form-description-p">Path to a <a href="https://chromium.googlesource.com/chromium/src/+/master/docs/user_data_dir.md">User Data Directory</a>. The user data directory contains profile data such as history, bookmarks, and cookies, as well as other per-installation local state. </p>
                                                          <p class="bitsky-form-description-p">After you set, then <b>Headless Producer</b> will have all those data, this means if you log in to <b>Gmail</b>, and session still valid, <b>Headless Producer</b> also will automatically login to <b>Gmail</b>.</p>
                                                          <p class="bitsky-form-description-p"><b>Important:</b>The <b>User Data Directory</b> should be the <b>User Data Directory</b> of the <b>Chrome</b>(<span class="ant-typography"><code>Browser Installation Path</code></span>) you selected</p>
                                                          <p class="bitsky-form-description-p">Example(Mac OSX): <span class="ant-typography"><code>/Users/Alice/Library/Application Support/Google/Chrome</code></span></p>`,
  ...
  // eslint-disable-next-line quotes
  'app.containers.HeadlessProducer.browserInstallationsDescription': `<p class="bitsky-form-description-p">Default use <span class="ant-typography"><code>Bundled Chromium</code></span>. You can choose an installed Chrome from dropdown.</p>
                                                                   <p class="bitsky-form-description-p"><b>Note:&nbsp;</b><a href="https://github.com/puppeteer/puppeteer/#q-why-doesnt-puppeteer-vxxx-work-with-chromium-vyyy">Puppeteer</a> is only guaranteed to work with the <span class="ant-typography"><code>Bundled Chromium</code></span></p>`,
